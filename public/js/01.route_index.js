...
function showRequestForm(route_id){
	...
	if ($("#chselectroute").prop("checked") && $("#route_id").val() > 0)
		$("#modal_request_content").load("/route/modal-request-form/recipient_route_id/"+route_id+"/sender_route_id/"+$("#route_id").val() + "/is_driver/" + $("#userlist1").val());
	else
		$("#modal_request_content").load("/route/modal-request-form/recipient_route_id/"+route_id+"/sender_route_id/0" + "/is_driver/" + $("#userlist1").val());
