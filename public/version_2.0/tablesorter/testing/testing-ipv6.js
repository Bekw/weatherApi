...
QUnit.extend(QUnit.assert, {
	ipv6test: function(result, str, expect){
		if (result) {
			// ok( $.tablesorter.regex.ipv6Validate.addvs(str), "valid: " + str );
...
ipv6tests = function(){
	...
	QUnit.test( "ipv6 parser", function(assert) {
		...
		// IPV6 tests by Rich Brown copied from http:// download.dartware.com/thirdparty/addvs-ipv6-regex.pl
		...
		// aeron supplied these addvs cases
